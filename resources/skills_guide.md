...
## Skill Architecture
Alexa skills consist of a front end and a back end. 
For the purposes of this tutorial, we will be hosting our back end on AWS Lambda and defining our interaction module (front end) in the Alexa Developer Console.

### Set Up
+ Before you begin, you must have an Amazon Developer Account. If you do not have one, create one via [this link](https://developer.amazon.com/home.html).
+ You must also have an AWS Account. If you do not have one, create one via [this link](https://aws.amazon.com/resources/create-account/).
